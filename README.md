...
- Evolução gradual para serverless puro
- Tolerância a falhas
- Arquitetura observável por eventos

---

# 📈 Roadmap Técnico

- Substituir `Scan` por GSI no DynamoDB
- Adicionar SQS entre etapas críticas
- Implementar DLQ para Lambdas
- Migrar EC2 → API Gateway + Lambda
- Implementar autenticação JWT/Cognito
- Adicionar observabilidade (OpenTelemetry + CloudWatch)

---

# 🧠 Conclusão

Este projeto demonstra uma arquitetura moderna e escalável de sistemas distribuídos, combinando:

- Backend tradicional (EC2 + Express)
...
> Um sistema resiliente, escalável e pronto para evolução para microservices e arquitetura 100% serverless.
